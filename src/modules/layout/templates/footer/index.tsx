        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 py-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-stone-600 text-sm max-w-sm">
              Turning moments into precision-plotted art. 
              Real ink, real paper, drawn by robots.
            </p>
            {/* Social Links */}
            <div className="flex gap-4 mt-6">
              <a href="#" className="w-10 h-10 rounded-full bg-stone-200 hover:bg-amber-100 flex items-center justify-center transition-colors">
