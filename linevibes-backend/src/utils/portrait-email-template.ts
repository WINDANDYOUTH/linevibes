...
export function generatePortraitDownloadEmail(data: PortraitEmailData): string {
  ...
  const svgButton = data.downloadUrlSvg
    ? `
                <tr>
  ...
  const svgDetailsRow = data.downloadUrlSvg
    ? `
                  <tr>
          ...
          <tr>
            <td style="padding:32px 40px;">
              <p style="color:#374151;font-size:15px;line-height:1.6;margin:0 0 24px;">
                Thank you for your purchase. Your finished portrait files are ready to download.
                The PNG file is watermark-free and prepared at high resolution.
              </p>
              ...
              <div style="background-color:#f9fafb;border-radius:10px;padding:16px 20px;margin-top:24px;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;color:#374151;">
                  <tr>
                    ...
                    <td style="padding:4px 0;text-align:right;color:#6b7280;">Up to 4096 x 4096 px</td>
                  </tr>
${svgDetailsRow}
                  <tr>
          ...
          <tr>
            <td style="background-color:#f9fafb;padding:20px 40px;text-align:center;border-top:1px solid #e5e7eb;">
              <p style="color:#9ca3af;font-size:12px;margin:0;">
                (c) ${new Date().getFullYear()} LineVibes | All rights reserved
              </p>
            </td>
          </tr>
        </table>
